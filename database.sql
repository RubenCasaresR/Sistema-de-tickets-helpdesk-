...
CREATE TABLE comentarios_ticket (
    ...
    es_interna TINYINT(1) NOT NULL DEFAULT 0,
...
-- ============================================================
-- TABLA: ticket_historial (Auditoría de cambios en tickets)
-- ============================================================
...
-- ============================================================
-- Módulo Gestor de Tareas (v2026-06-04)
-- ============================================================
